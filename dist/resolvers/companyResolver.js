    ...
    Company: {
        ...
        organization: (company) => __awaiter(void 0, void 0, void 0, function* () {
            if (!company.organizationId)
                return null;
            return yield organizationService_1.organizationService.getById(company.organizationId);
        })
    }
};
