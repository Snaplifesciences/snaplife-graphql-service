...
const companyAPI_1 = require("../../datasources/companyAPI");
...
class CompanyService {
    createCompany(input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield companyAPI_1.companyAPI.create(input);
            }
            catch (error) {
    ...
    getById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield companyAPI_1.companyAPI.getById(id);
            }
            catch (error) {
    ...
    findByName(name) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield companyAPI_1.companyAPI.findByName(name);
            }
            catch (error) {
    ...
    getAllByOrganizationId(organizationId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield companyAPI_1.companyAPI.getByOrganizationId(organizationId);
            }
            catch (error) {
    ...
    getAllCompanies() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield companyAPI_1.companyAPI.getAll();
            }
            catch (error) {
    ...
    updateCompany(id, input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield companyAPI_1.companyAPI.update(id, input);
            }
            catch (error) {
    ...
    deleteCompany(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield companyAPI_1.companyAPI.delete(id);
            }
            catch (error) {
