...
const authAPI_1 = require("../../datasources/authAPI");
class AuthService {
    signInWithPassword(email, password) {
        return __awaiter(this, void 0, void 0, function* () {
            console.log('signInWithPassword called with email:', email);
            try {
                return yield authAPI_1.authAPI.signInWithPassword(email, password);
            }
            catch (error) {
    ...
    refreshUserToken(refreshToken) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield authAPI_1.authAPI.refreshToken(refreshToken);
            }
            catch (error) {
