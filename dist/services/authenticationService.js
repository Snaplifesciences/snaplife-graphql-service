...
class AuthenticationService {
    signInWithPassword(email, password) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield authServiceClient_1.authServiceClient.signInWithPassword(email, password);
            }
            catch (error) {
    ...
    refreshUserToken(refreshToken) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                return yield authServiceClient_1.authServiceClient.refreshToken(refreshToken);
            }
            catch (error) {
